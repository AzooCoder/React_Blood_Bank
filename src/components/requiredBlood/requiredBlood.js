...
class RequiredBlood extends Component {
    ...
    constructor(props) {
        ...
        this.allDonors = [];
        this.state = { open: false, applications: '',requiredBlood:'' };
                                    ...
                                    if(that.testBlood(todo.bloodType)){
                                        return (
                                            <mat.TableRow key={index} selectable={false}>
                                                ...
                                                <mat.TableHeaderColumn><mat.RaisedButton type="button" label="Submit" primary={true} onClick={() => this.handleRequiredRequest(todo)}/></mat.TableHeaderColumn>
